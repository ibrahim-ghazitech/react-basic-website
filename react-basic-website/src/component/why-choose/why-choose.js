                ...
                <div className="why-choose-wrapper flex align-center">
                    ...
                    <div className="why-choose-content">
                        ...
                        <h5 className="why-choose-heading primary-heading">
                            ...
                            with IT <span className="bg-change">solutions</span>
                        </h5>
                        <p className="why-choose-bottom-para">
                            Ut enim ad minima veniam, quis nostrum exercita tionem ullam susc ipit
                            labor iosam, nisut alationem ulla nima venia cipit lab.
                        </p>
