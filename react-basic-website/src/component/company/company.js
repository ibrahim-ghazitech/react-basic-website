                    ...
                    <div className="company-wrapper w-100 flex align-center">
                        ...
                        <div className="company-content w-50">
                            ...
                            <h3 className="company-heading">
                                {"Future proof your business with our IT "}
                                <span className="bg-change">{"solutions"}</span>
                            </h3>
                            <p className="company-bottom-para">
                                {"State burst think end are its. Arrived off she elderly beloved him affix ednoisier yet. Course regard to up he hardly elder noisier."}
                            </p>
